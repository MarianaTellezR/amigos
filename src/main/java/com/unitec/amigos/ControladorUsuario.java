...
public class ControladorUsuario {
    //Aqui va el metodo que representa cada uno de los estados que vamos a transferiri, es decir, va un GET, POST, PUT y DELETE, como minimo.
    ...
    public Estatus guardar(@RequestBody String json)throws Exception{
        //Primero leemos y convertimos el obketo json a objeto Java
        ObjectMapper mapper=new ObjectMapper();
        Usuario u=mapper.readValue(json,Usuario.class);
        //Este usuario, ya en formato json lo guardamos en mongodb
        repoUsuario.save(u);
        //Creamos un objetos de tipo Estatus y este objeto lo retornamos al cliente(android o postman)
